...
- **UX da O.P. e Trava de Campos:** Adicionado o campo `p-turno` na array de travamento. Além disso, adicionada uma trava inteligente de foco: ao digitar um produto válido que exige OP e pressionar `Enter`, se a OP não estiver preenchida, o sistema aborta o salto rápido de campos e joga o ponteiro forçosamente para o campo da O.P, impedindo que o modal de alerta seja ocultado.
